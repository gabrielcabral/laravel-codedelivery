...
Route::group(
    ['prefix' => 'admin', 'middleware' => 'auth.checkrole:Admin', 'as' => 'admin.'], function () {

    Route::get('categories', ['as' => 'categories.index', 'uses' => 'CategoriesController@index']);
    Route::group(
        ['prefix' => 'categories', 'as' => 'categories.'], function () {
    ...
    Route::group(
        ['prefix' => 'clients', 'as' => 'clients.'], function () {
    ...
    Route::group(
        ['prefix' => 'orders', 'as' => 'orders.'], function () {
        ...
        Route::group(
            ['prefix' => 'itens', 'as' => 'itens.'], function () {
    ...
    Route::group(
        ['prefix' => 'cupoms', 'as' => 'cupoms.'], function () {
...
Route::group(
    ['prefix' => 'customer', 'middleware' => 'auth.checkrole:client', 'as' => 'customer.'], function () {
...
Route::group(
    ['prefix' => 'api', 'middleware' => 'oauth', 'as' => 'api.'], function () {

    Route::group(
        ['prefix' => 'client', 'middleware' => 'oauth.checkrole:client', 'as' => 'client.'], function () {
        Route::resource(
            'order', 'Api\Client\ClientCheckoutController',
    ...
    Route::group(
        ['prefix' => 'deliveryman', 'middleware' => 'oauth.checkrole:deliveryman', 'as' => 'deliveryman.'], function () {
        Route::resource(
            'order', 'Api\Deliveryman\DeliverymanCheckoutController', [
